...
<option value="https://abcotvdata.github.io/safetytracker_fayetteville/Fayetteville_Safety_Tracker_SexualAssaults.html">Sexual Assaults</option>
...
<option value="https://abcotvdata.github.io/safetytracker_raleigh/Raleigh_Safety_Tracker.html">Raleigh</option><option value="https://abcotvdata.github.io/safetytracker_durham/Durham_Safety_Tracker.html">Durham</option>
...
<subhead>A closer look at Fayetteville aggravated assaults neighborhood by neighborhood</subhead>

The danger is not the same neighborhood to neighborhood. ABC11's data team looked at the Fayetteville Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
Fayetteville_assault_map <- leaflet(assaults_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
Fayetteville_assault_map
```
<br>
<br>
<iframe title="Aggravated assaults year by year in Fayetteville" aria-label="Column Chart" id="datawrapper-chart-vyzuu" src="https://datawrapper.dwcdn.net/vyzuu/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();
</script>
<!-- <subhead>Risk of assault and other violent crimes in Oakland </subhead> -->
<br>
<br>
<iframe title="2021 violent crime rate comparison in select cities" aria-label="Bar Chart" id="datawrapper-chart-Hme14" src="https://datawrapper.dwcdn.net/Hme14/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="653" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();</script>
<br>
<br>
