...
rmarkdown::render('scripts/Fayetteville_Safety_Tracker.Rmd', 
                  output_dir = "docs",
                  output_file = 'Fayetteville_Safety_Tracker.html')
...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Fayetteville_Safety_Tracker_Burglaries.Rmd', 
                  output_dir = "docs",
                  output_file = "Fayetteville_Safety_Tracker_Burglaries.html")
...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Fayetteville_Safety_Tracker_Thefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Fayetteville_Safety_Tracker_Thefts.html')
...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Fayetteville_Safety_Tracker_AutoThefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Fayetteville_Safety_Tracker_AutoThefts.html')
...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Fayetteville_Safety_Tracker_Robberies.Rmd', 
                  output_dir = "docs",
                  output_file = 'Fayetteville_Safety_Tracker_Robberies.html')
...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Fayetteville_Safety_Tracker_Assaults.Rmd', 
                  output_dir = "docs",
                  output_file = 'Fayetteville_Safety_Tracker_Assaults.html')
