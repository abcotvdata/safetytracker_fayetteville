...
citywide_category %>% select(1:16) %>% filter(category=="Murder") %>% write_csv("data/output/yearly/murders_city.csv")
citywide_category %>% select(1:16) %>% filter(category=="Sexual Assault") %>%  write_csv("data/output/yearly/sexassaults_city.csv")
citywide_category %>% select(1:16) %>% filter(category=="Motor Vehicle Theft") %>%  write_csv("data/output/yearly/autothefts_city.csv")
citywide_category %>% select(1:16) %>% filter(category=="Theft") %>%  write_csv("data/output/yearly/thefts_city.csv")
citywide_category %>% select(1:16) %>% filter(category=="Burglary") %>%  write_csv("data/output/yearly/burglaries_city.csv")
