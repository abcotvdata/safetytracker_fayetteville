...
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Murder") %>% write_csv("data/output/yearly/murders_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Sexual Assault") %>%  write_csv("data/output/yearly/sexassaults_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Motor Vehicle Theft") %>%  write_csv("data/output/yearly/autothefts_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Theft") %>%  write_csv("data/output/yearly/thefts_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Burglary") %>%  write_csv("data/output/yearly/burglaries_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Robbery") %>%  write_csv("data/output/yearly/robberies_city.csv")
citywide_category %>% select(1:16) %>% rename_with(~ gsub("total", "20", .x)) %>% filter(category=="Aggravated Assault") %>%  write_csv("data/output/yearly/assaults_city.csv")
