...
<subhead>A closer look at Fayetteville robberies neighborhood by neighborhood</subhead>
...
Fayetteville_robbery_map <- leaflet(robberies_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
Fayetteville_robbery_map
```
<br>
<br>
<iframe title="Robberies year by year in Fayetteville" aria-label="Column Chart" id="datawrapper-chart-AjVW0" src="https://datawrapper.dwcdn.net/AjVW0/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(a){if(void 0!==a.data["datawrapper-height"]){var e=document.querySelectorAll("iframe");for(var t in a.data["datawrapper-height"])for(var r=0;r<e.length;r++)if(e[r].contentWindow===a.source){var i=a.data["datawrapper-height"][t]+"px";e[r].style.height=i}}}))}();</script>
<br>
<br>
